...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsetEnterpriseInspector.RuleDetailsResponseRULE();
  });
  ...
  describe('RuleDetailsResponseRULE', function() {
    it('should create an instance of RuleDetailsResponseRULE', function() {
      // uncomment below and update the code to test RuleDetailsResponseRULE
      //var instane = new EsetEnterpriseInspector.RuleDetailsResponseRULE();
      //expect(instance).to.be.a(EsetEnterpriseInspector.RuleDetailsResponseRULE);
    });

    it('should have the property body (base name: "body")', function() {
      // uncomment below and update the code to test the property body
      //var instance = new EsetEnterpriseInspector.RuleDetailsResponseRULE();
