...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsetEnterpriseInspector.RuleCreateResponse();
  });
  ...
  describe('RuleCreateResponse', function() {
    it('should create an instance of RuleCreateResponse', function() {
      // uncomment below and update the code to test RuleCreateResponse
      //var instane = new EsetEnterpriseInspector.RuleCreateResponse();
      //expect(instance).to.be.a(EsetEnterpriseInspector.RuleCreateResponse);
    });

    it('should have the property body (base name: "body")', function() {
      // uncomment below and update the code to test the property body
      //var instance = new EsetEnterpriseInspector.RuleCreateResponse();
