...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EsetEnterpriseInspector.RuleListResponseValue();
  });
  ...
  describe('RuleListResponseValue', function() {
    it('should create an instance of RuleListResponseValue', function() {
      // uncomment below and update the code to test RuleListResponseValue
      //var instane = new EsetEnterpriseInspector.RuleListResponseValue();
      //expect(instance).to.be.a(EsetEnterpriseInspector.RuleListResponseValue);
    });

    it('should have the property enabled (base name: "enabled")', function() {
      // uncomment below and update the code to test the property enabled
      //var instance = new EsetEnterpriseInspector.RuleListResponseValue();
