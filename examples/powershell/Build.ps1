...
$Manifest = @{
    ...
    Description = 'PSOpenAPITools - the PowerShell module for ESET Enterprise Inspector'

    ModuleVersion = '0.1.2'

    RootModule = 'PSOpenAPITools.psm1'
    Guid = '{B745589A-B4CF-4990-836D-3037A611CB4E}' # Has to be static, otherwise each new build will be considered different module
