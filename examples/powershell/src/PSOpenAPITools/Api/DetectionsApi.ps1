...
function Get-DetectionDetails {
    ...
    Process {
        'Calling method: Get-DetectionDetails' | Write-Debug
        ...
        $LocalVarUri = '/api/v1/detections/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling getDetectionDetails."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "DetectionDetailsResponse" `
...
#>
function Invoke-ListDetections {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
    ...
    Process {
        'Calling method: Invoke-ListDetections' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "DetectionListResponse" `
                                -IsBodyNullable $false
...
.PARAMETER DetectionUpdateRequest
No description available.
...
function Update-Detection {
    ...
    Process {
        'Calling method: Update-Detection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/api/v1/detections/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling updateDetection."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', $Id)
        ...
        if (!$DetectionUpdateRequest) {
            throw "Error! The required parameter `DetectionUpdateRequest` missing when calling updateDetection."
        }

        $LocalVarBodyParameter = $DetectionUpdateRequest | ConvertTo-Json -Depth 100
