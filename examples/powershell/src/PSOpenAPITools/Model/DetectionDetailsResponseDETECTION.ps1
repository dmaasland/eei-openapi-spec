...
.PARAMETER Id
No description available.
.PARAMETER ModuleFirstSeenLocally
No description available.
.PARAMETER ModuleId
No description available.
.PARAMETER ModuleLastExecutedLocally
No description available.
...
DetectionDetailsResponseDETECTION<PSCustomObject>
#>

function Initialize-DetectionDetailsResponseDETECTION {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DetectionDetailsResponseDETECTION' | Write-Debug
        ...
        $PSO = [PSCustomObject]@{
            ...
            "handled" = ${Handled}
            "id" = ${Id}
            "moduleFirstSeenLocally" = ${ModuleFirstSeenLocally}
            "moduleId" = ${ModuleId}
            "moduleLastExecutedLocally" = ${ModuleLastExecutedLocally}
...
Convert from JSON to DetectionDetailsResponseDETECTION<PSCustomObject>
...
DetectionDetailsResponseDETECTION<PSCustomObject>
#>
function ConvertFrom-JsonToDetectionDetailsResponseDETECTION {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DetectionDetailsResponseDETECTION' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DetectionDetailsResponseDETECTION
        $AllProperties = ("computerId", "computerName", "computerUuid", "creationTime", "event", "handled", "id", "moduleFirstSeenLocally", "moduleId", "moduleLastExecutedLocally", "moduleLgAge", "moduleLgPopularity", "moduleLgReputation", "moduleName", "moduleSha1", "moduleSignatureType", "moduleSigner", "note", "priority", "processCommandLine", "processId", "processPath", "processUser", "resolved", "ruleName", "ruleUuid", "severity", "severityScore", "threatName", "threatUri", "type", "uuid")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "handled"))) { #optional property not found
            $Handled = $null
        } else {
            $Handled = $JsonParameters.PSobject.Properties["handled"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "moduleFirstSeenLocally"))) { #optional property not found
            $ModuleFirstSeenLocally = $null
        } else {
            $ModuleFirstSeenLocally = $JsonParameters.PSobject.Properties["moduleFirstSeenLocally"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "moduleLastExecutedLocally"))) { #optional property not found
            $ModuleLastExecutedLocally = $null
        } else {
            $ModuleLastExecutedLocally = $JsonParameters.PSobject.Properties["moduleLastExecutedLocally"].value
        }
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "processPath"))) { #optional property not found
            $ProcessPath = $null
        } else {
            $ProcessPath = $JsonParameters.PSobject.Properties["processPath"].value
        }
