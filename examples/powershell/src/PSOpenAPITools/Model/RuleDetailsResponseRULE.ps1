...
RuleDetailsResponseRULE<PSCustomObject>
#>

function Initialize-RuleDetailsResponseRULE {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RuleDetailsResponseRULE' | Write-Debug
...
Convert from JSON to RuleDetailsResponseRULE<PSCustomObject>
...
RuleDetailsResponseRULE<PSCustomObject>
#>
function ConvertFrom-JsonToRuleDetailsResponseRULE {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RuleDetailsResponseRULE' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RuleDetailsResponseRULE
